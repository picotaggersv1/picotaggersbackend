...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "134B31"
        self.SecretKey : str = "XGAI4JNPZM13E16H89TISE9CW9T879D9WQXKZYP3O8FB6IDCGO"
        self.ApiKey : str = "OC|9218392054929034|e85940e609984383b86fb9ef7e1deadc"
